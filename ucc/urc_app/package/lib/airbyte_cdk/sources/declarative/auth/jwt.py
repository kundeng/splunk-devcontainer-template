...
try:
    ...
    EllipticCurvePrivateKey = None  # type: ignore[assignment,misc]
    Ed448PrivateKey = None  # type: ignore[assignment,misc]
    Ed25519PrivateKey = None  # type: ignore[assignment,misc]
    RSAPrivateKey = None  # type: ignore[assignment,misc]
